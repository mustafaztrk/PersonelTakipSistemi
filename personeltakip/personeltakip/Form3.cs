...
namespace personeltakip
{
    public partial class Form3 : Form
    {
        ...
        private void personelleri_goster() 
        {
            ...
            {
                baglantim.Open();
                OleDbDataAdapter personelleri_listele = new OleDbDataAdapter("select tcno AS[TC KİMLİK NO],ad AS[ADI],soyad AS[SOYADI],cinsiyet AS[CİNSİYET],mezuniyet AS[MEZUNİYET],dogumtarihi AS[DOĞUM TARİHİ],gorevyeri AS[GÖREVİ],gorevyeri AS[GÖREV YERİ],maasi AS[MAAŞI] from personeller Order By ad ASC", baglantim);
